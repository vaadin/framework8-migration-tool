...
public class Migrate {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String m2folder = System.getenv("M2_HOME");
        if (m2folder == null) {
            m2folder = System.getenv("HOME") + "/.m2";
        }

        String compatServerFilename = m2folder
                + "/repository/com/vaadin/vaadin-compatibility-server/8.0-SNAPSHOT/vaadin-compatibility-server-8.0-SNAPSHOT.jar";
        String compatSharedFilename = compatServerFilename.replace("server",
                "shared");
